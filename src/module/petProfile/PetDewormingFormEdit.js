...
const PetDewormingFormEdit = props => {
    ...
    const [doses, setDoses] = useState(typeof testDetail.doses != 'undefined' && testDetail.doses != null && testDetail.doses != 'null' ? testDetail.doses :'');
                ...
                <View
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <TextInput
                            style={styles.textField}
                            value={doses}
                            onChangeText={text => setDoses(text.replace(/[^A-Za-z0-9 ]/gi, ''))}
                        />
...
export default PetDewormingFormEdit;
